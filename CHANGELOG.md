...
## [12.0.0](https://github.com/tarjeir/codecompanion.nvim/compare/v12.7.0...v12.0.0) (2025-02-22)
...
* [#604](https://github.com/tarjeir/codecompanion.nvim/issues/604) `send_code` can be a function ([30b899e](https://github.com/tarjeir/codecompanion.nvim/commit/30b899e638d5525494b64eacd19b1c0eb50f988c))
...
* **adapters:** add Hugging Face adapter ([#527](https://github.com/tarjeir/codecompanion.nvim/issues/527)) ([48747c4](https://github.com/tarjeir/codecompanion.nvim/commit/48747c4e36eb0a3f44d6d9e55f8089b9e27cacfc))
...
* **adapters:** update `copilot` and `openai` adapters for o1 models ([c7ba92a](https://github.com/tarjeir/codecompanion.nvim/commit/c7ba92ad367939e94bfa23df7e3eb1bc74909348))
* add native completions ([a1147f8](https://github.com/tarjeir/codecompanion.nvim/commit/a1147f8133707251603525acf6a87f5c12ef3a70))
...
* **chat:** :sparkles: `blink.cmp` support ([cb2c93f](https://github.com/tarjeir/codecompanion.nvim/commit/cb2c93f8a6b0ab0522a814f244b8011a7275ea3b))
* **chat:** :sparkles: can pin buffers and files to requests ([fc8ee3a](https://github.com/tarjeir/codecompanion.nvim/commit/fc8ee3a085a44d0ef0111be0499f6552d7dbe865))
...
* **chat:** add `CodeCompanionChatOpened` event ([fdfc640](https://github.com/tarjeir/codecompanion.nvim/commit/fdfc640f638de7e44580c75882b81cc6dd99b950))
* **chat:** adding to chat initializes buffer if needed ([#567](https://github.com/tarjeir/codecompanion.nvim/issues/567)) ([8c82ced](https://github.com/tarjeir/codecompanion.nvim/commit/8c82cedc3d70255ec6ea0fdb348b3e931c435fba))
* **chat:** can delete references ([367eccc](https://github.com/tarjeir/codecompanion.nvim/commit/367eccc7cc57edcc249bae850ac4ccdf599a060c))
* **chat:** can delete references ([c0b8c25](https://github.com/tarjeir/codecompanion.nvim/commit/c0b8c2522c20b8369201132a4ce953f3cdf7b5e2))
* **chat:** customize split position ([#556](https://github.com/tarjeir/codecompanion.nvim/issues/556)) ([7374192](https://github.com/tarjeir/codecompanion.nvim/commit/73741920097f36c762bb8fe1f4de6617389e2d4c))
...
* **chat:** keymaps can be custom functions ([5f729f9](https://github.com/tarjeir/codecompanion.nvim/commit/5f729f91a6b6a4025f8e4753d2c2c29810da0149))
...
* **completion:** auto setup blink.cmp ([90a6603](https://github.com/tarjeir/codecompanion.nvim/commit/90a66033ffddb2f1daac0e5d23723214673ab0e5))
* **completion:** suggestions in blink have better score ([4317513](https://github.com/tarjeir/codecompanion.nvim/commit/4317513cdb5fb7f35147448e3ca696756bf82cf2))
...
* **copilot:** add token count ([4fd26a6](https://github.com/tarjeir/codecompanion.nvim/commit/4fd26a6fd9bc6aa4e88176350a05ff7e16b3a789))
...
* **event:** add `CodeCompanionChatPin` event ([f86f4a7](https://github.com/tarjeir/codecompanion.nvim/commit/f86f4a72dd154bb677d117e06cab9a9ee8d35f56))
...
* **keymaps:** add condition logic ([c4eb21e](https://github.com/tarjeir/codecompanion.nvim/commit/c4eb21e89ecf466416b75395ac00bf3db83838e7))
...
* **prompts:** system prompt is optional for custom prompts ([90820fc](https://github.com/tarjeir/codecompanion.nvim/commit/90820fcdb5e6a570dc4f92731fade4d5f716ea02))
...
* **slash_cmd:** notify if no terminal buffer is found ([3687b88](https://github.com/tarjeir/codecompanion.nvim/commit/3687b8807746700851f13a373ad6ead04bb082bd))
* **slash_cmds:** `buffer` slash command now sends line numbers ([25dab99](https://github.com/tarjeir/codecompanion.nvim/commit/25dab9939e5065a59207d3b77eefc63e4b6e9fc0))
...
* **slash_commands:** `help` cmd now prompts user to trim if exceeding max_lines ([33c326a](https://github.com/tarjeir/codecompanion.nvim/commit/33c326a0d31473ecf3112d783dbcc22afccfb801))
...
* [#501](https://github.com/tarjeir/codecompanion.nvim/issues/501) `blink.compat` causing issues with completion menu ([c5065d0](https://github.com/tarjeir/codecompanion.nvim/commit/c5065d02916d8c1bf5dd3baf9f0dd5e1f017fd57))
* [#542](https://github.com/tarjeir/codecompanion.nvim/issues/542) use vim.treesitter instead of nvim-treesitter. ([#543](https://github.com/tarjeir/codecompanion.nvim/issues/543)) ([b741490](https://github.com/tarjeir/codecompanion.nvim/commit/b741490066c0129554300e493f27767b760ffa16))
...
* **adapters:** [#528](https://github.com/tarjeir/codecompanion.nvim/issues/528) Gemini adapter fails if system prompt is removed ([7ca4364](https://github.com/tarjeir/codecompanion.nvim/commit/7ca43642376d7768a3f2ecea2cd99ae9a792451a))
* **adapters:** [#560](https://github.com/tarjeir/codecompanion.nvim/issues/560) nil url in openai_compatible adpater ([5cc2693](https://github.com/tarjeir/codecompanion.nvim/commit/5cc26934b0732dda03d311195e6d3f357e4f4a0c))
...
* **adapters:** further openai_compatible fixes ([a84f6ff](https://github.com/tarjeir/codecompanion.nvim/commit/a84f6ff4be745bcff7d69af96fdbdae2465a33a2))
* **adapters:** gemini-2.0-flash-exp inline strategy ([#568](https://github.com/tarjeir/codecompanion.nvim/issues/568)) ([a9faa69](https://github.com/tarjeir/codecompanion.nvim/commit/a9faa69d3bf8308b78deab97292af2acc57d2f87))
...
* **adapters:** openai_compatible ([0d1388f](https://github.com/tarjeir/codecompanion.nvim/commit/0d1388f7409f06e96ef2a7eadfa76c1dcfb74648))
* allow for multiple completions in a single line ([3516e46](https://github.com/tarjeir/codecompanion.nvim/commit/3516e46a62ebb151e6fa0afe4ac631432994cc3a))
* **blink:** [#587](https://github.com/tarjeir/codecompanion.nvim/issues/587) slash commands ([1b8ab18](https://github.com/tarjeir/codecompanion.nvim/commit/1b8ab18cd0be76f13d13e6deaa56e6c33dce5a23))
* **blink:** slash commands leaving brackes in chat buffer ([820bc52](https://github.com/tarjeir/codecompanion.nvim/commit/820bc52c7b4a5a494773a3aa4e25e9e36659e378))
...
* **chat:** prevent double adding of references ([953b20d](https://github.com/tarjeir/codecompanion.nvim/commit/953b20dabf63e4e5c7b30b9d32cd1136291aceb1))
...
* **chat:** show documentation for blink.cmp ([f41dbab](https://github.com/tarjeir/codecompanion.nvim/commit/f41dbab850572b290e37e0b52244b8ccb9699870))
* **chat:** slash commands from prompt library not visible ([3376f60](https://github.com/tarjeir/codecompanion.nvim/commit/3376f6052217737cb936236d9069bd4a63ccbace))
* **cmd:** strategy now respects `vim.g.codecompanion_adapter` ([b629005](https://github.com/tarjeir/codecompanion.nvim/commit/b629005f0467471b4439192492cea2d49f22d52f))
* **cmp:** extend default sources ([8b0ebb4](https://github.com/tarjeir/codecompanion.nvim/commit/8b0ebb4092c3266746663443d1b8dff13e3ba723))
* **completion:** [#597](https://github.com/tarjeir/codecompanion.nvim/issues/597) blink configuration ([a1166d5](https://github.com/tarjeir/codecompanion.nvim/commit/a1166d5a2e9249f81060d328859382be57eae79d))
...
* **completion:** setting of keymaps ([03fbb0a](https://github.com/tarjeir/codecompanion.nvim/commit/03fbb0ac20d3a028d9462efe49f3d53b60e92a8a))
* **config:** wrap completion condition in pcall ([d19ae05](https://github.com/tarjeir/codecompanion.nvim/commit/d19ae05f561a7d3b5d311453285996e84cc925de))
...
* **gemini:** remove cycle from system prompt ([d6b95bb](https://github.com/tarjeir/codecompanion.nvim/commit/d6b95bb6cbf074e2e431c6a7f9acdd1af7cc9397))
...
* **inline:** [#516](https://github.com/tarjeir/codecompanion.nvim/issues/516) switching adapters via `vim.g.codecompanion_adapter` ([0d91c08](https://github.com/tarjeir/codecompanion.nvim/commit/0d91c086b30da050aa0a95dd9e69d16d9d88c587))
* **inline:** [#531](https://github.com/tarjeir/codecompanion.nvim/issues/531) inline edits in c++ buffers ([73e8ea5](https://github.com/tarjeir/codecompanion.nvim/commit/73e8ea561e81cce3b9c75d825b8294e0a82fc4e9))
...
* **keymaps:** completion menu is now `&lt;c-_&gt;` ([24f296b](https://github.com/tarjeir/codecompanion.nvim/commit/24f296bd2382bc9f50d387b5ac849410d6c2d491))
...
* mini.pick as action_palette provider ([adeb7c4](https://github.com/tarjeir/codecompanion.nvim/commit/adeb7c42fb7fb1187c64773a46d5bfee8f85dacf))
...
* **slash_commands:** [#515](https://github.com/tarjeir/codecompanion.nvim/issues/515) help tags line limit can be customised ([e1b9876](https://github.com/tarjeir/codecompanion.nvim/commit/e1b9876641e4ea0fa80f78339c260b16b729a21f))
...
* **slash_commands:** fetch doesn't error on no input ([be9e36c](https://github.com/tarjeir/codecompanion.nvim/commit/be9e36c217f15ff53b06c9eb2ba7c42de026dc70))
...
* **slash_commands:** prompt library now works with blink.cmp ([1027f47](https://github.com/tarjeir/codecompanion.nvim/commit/1027f47c6c583a6b6592ae60a8008d780517792a))
...
* **tools:** [#503](https://github.com/tarjeir/codecompanion.nvim/issues/503) shell redirection ([7023e58](https://github.com/tarjeir/codecompanion.nvim/commit/7023e58a056cb834cd3620fec6c42de37469109b))
...
* **tools:** explictly add cwd to `plenary.job` call ([e78006d](https://github.com/tarjeir/codecompanion.nvim/commit/e78006d5a09f0bc9ec78aab4f2a53a4d6bf40149))
...
* **tools:** output correctly in the chat buffer ([3a6acfb](https://github.com/tarjeir/codecompanion.nvim/commit/3a6acfbc52989848b8264fe415380747a9af5615))
* **tools:** rejected cmd tools close properly ([50d0d25](https://github.com/tarjeir/codecompanion.nvim/commit/50d0d2543ed3115477cfacfd80db0e029857127e))
* **tools:** remove ANSI sequences from all output ([2836849](https://github.com/tarjeir/codecompanion.nvim/commit/2836849c6e1533fc54d06e88d52354374efc728d))
* **tools:** strip ansi from cmd output ([679a9a5](https://github.com/tarjeir/codecompanion.nvim/commit/679a9a513f61a5d4e622c7506599cad55f35e502))
...
* **utils:** [#488](https://github.com/tarjeir/codecompanion.nvim/issues/488) fix edge cases in visual selection ([84a8e89](https://github.com/tarjeir/codecompanion.nvim/commit/84a8e8962e9ae20b8357d813dee1ea44a8079605))
...
* **utils:** visual selection range no longer uses feedkeys ([e981da2](https://github.com/tarjeir/codecompanion.nvim/commit/e981da23ae0e900a4086e8dcbc0b6abf86b737a9))
* **workflow:** can auto_submit the first prompt ([86f96d5](https://github.com/tarjeir/codecompanion.nvim/commit/86f96d5419915b0711afbc93d948a3312bfc25b6))
* **workflows:** wrap in `vim.schedule` for performance ([f0f6e26](https://github.com/tarjeir/codecompanion.nvim/commit/f0f6e260a98c5ffe6ff6257227d1f429a4ecb07c))
...
* **http:** improve resiliency of requests ([d99928b](https://github.com/tarjeir/codecompanion.nvim/commit/d99928b5503788651b0b67bb3a577746763c7349))
...
* **agents:** agents are now in `strategies.chat.agents` ([3f437a6](https://github.com/tarjeir/codecompanion.nvim/commit/3f437a62d55ad6efe14a4af2ffdc4e474696852a))
